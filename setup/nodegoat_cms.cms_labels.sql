...
('inf_import_assign_no_object_to_string', 'en', 'Click to assign no object to this string'),
('inf_import_assign_object_to_string', 'en', 'Click to assign object to this string'),
...
('lbl_import_show_log', 'en', 'Show Log'),
...
('msg_import_done', 'en', 'This import run has [V][verb] <strong>[V][object_amount]</strong> Objects. Go to the [url=/login/data]Data section of your environment[/url] to inspect these Objects.'),
('msg_import_error_at_row_number', 'en', 'An error occurred while processing row number [V][row_number].'),
('msg_import_error_at_value', 'en', 'The error occurred while processing the value(s):'),
('msg_import_error_message_was', 'en', 'The error message was:'),
('msg_import_error_resolving_filters', 'en', 'An error occurred while resolving the filters of this Import Template.'),
('msg_import_inspect_template_source', 'en', 'Inspect your Import Template and/or Source File to resolve this error.'),
('msg_import_limit_exceeded', 'en', 'This CSV file exceeds the limit of [V][limit] rows.'),
('msg_import_locked', 'en', 'Object was open for editing during the import process.'),
...
('msg_import_over_250_unmatched_filters', 'en', 'You have over 250 unmatched Filters. Please review your Import Template or CSV file.'),
('msg_import_resolve_unmatched_results', 'en', 'Resolve all unmatched results, then click Next.'),
('msg_import_stopped', 'en', 'The import process stopped.'),
