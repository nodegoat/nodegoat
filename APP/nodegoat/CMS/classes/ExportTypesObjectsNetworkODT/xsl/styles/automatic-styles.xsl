...
<!-- Specific -->
    ...
    <xsl:if test="count(//office:automatic-styles/style:style[@style:name = 'Heading_20_1_Break']) = 0">
        <style:style style:name="Heading_20_1_Break" style:display-name="Heading 1 Break"
                     style:family="paragraph" style:parent-style-name="Heading_20_1">
		    <style:paragraph-properties fo:break-before="page"/>
        </style:style>
        <style:style style:name="Heading_20_2_Break" style:display-name="Heading 2 Break"
                     style:family="paragraph" style:parent-style-name="Heading_20_2">
		    <style:paragraph-properties fo:break-before="page"/>
        </style:style>
        <style:style style:name="Heading_20_3_Break" style:display-name="Heading 3 Break"
                     style:family="paragraph" style:parent-style-name="Heading_20_3">
		    <style:paragraph-properties fo:break-before="page"/>
        </style:style>
    </xsl:if>
    
    <xsl:if test="count(//office:automatic-styles/style:style[@style:name = 'Text_20_body_Break']) = 0">
        <style:style style:name="Text_20_body_Break" style:display-name="Text Break"
